...
function getDiagramData(_a) {
    ...
    var sortedSprints = Array.from(entities.sprints.values())
        .sort(function (_a, _b) {
        var start1 = _a.startAt;
        var start2 = _b.startAt;
        return start1 - start2;
    })
        .map(function (sprint) { return sprint.id; });
